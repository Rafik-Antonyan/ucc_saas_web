  ...
  return (
    <>
      <PageHeader
        ...
        action={
          <Link className="inline-flex min-h-10 items-center gap-2 rounded-md bg-primary px-4 py-2 text-sm font-medium text-white hover:bg-emerald-800" href="/users/create">
